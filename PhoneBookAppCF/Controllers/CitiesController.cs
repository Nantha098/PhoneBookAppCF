...
namespace PhoneBookAppCF.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CityID,CityName,StateID,IsActive")] City city)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CityID,CityName,StateID,IsActive")] City city)
        {
            if (ModelState.IsValid)
            {
